...
Theo tài liệu phân công, nhóm được chia thành hai hướng chính: Platform \& Runtime và CI/CD \& Supply Chain. Cách chia này phù hợp với bản chất đồ án vì pipeline DevSecOps không chỉ là viết workflow GitHub Actions, mà còn cần hạ tầng cloud, registry, GitOps, Kubernetes runtime và bằng chứng vận hành.

\section{Vai trò theo tài liệu phân công}

\begin{table}[H]
\centering
\caption{Vai trò chính theo tài liệu phân công}
...
\midrule
Huỳnh Lê Đại Thắng & Cloud/IaC Owner & GCP, GKE, OpenTofu, VPC, IAM, Workload Identity, Secret Manager, Cloud Storage, CloudNativePG backup foundation, Redis. \\
Trần Nguyễn Việt Hoàng & Runtime Platform Owner & FluxCD, Kustomize, External Secrets Operator, Harbor runtime, Kubernetes manifests, policy/runtime hardening, runbooks. \\
...
Tài liệu phân công hiện tại nêu rõ Thắng là Cloud/IaC Owner; các vai trò còn lại được map theo phân công nhóm: Trần Nguyễn Việt Hoàng là Member 3, Nguyễn Trường Duy là Member 1 và Bùi Ngọc Thái là Member 2. Cách trình bày này giữ cấu trúc hai nhóm lớn để báo cáo có câu chuyện rõ ràng.

\section{Vertical slice auth-service}

Tài liệu phân công chọn \texttt{auth-service} làm vertical slice đầu tiên. Đây là lựa chọn hợp lý vì auth-service liên quan trực tiếp đến đăng nhập, JWT, RBAC và các request bảo vệ qua Gateway. Khi auth-service chạy được end-to-end từ PR đến GKE, nhóm có thể nhân rộng pattern sang các service khác.
