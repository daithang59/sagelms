...
\begin{itemize}
  \item Ứng dụng SageLMS: frontend React/Vite, Spring Boot Gateway, các service backend chính và AI Tutor FastAPI. AI Tutor đã có UI chat, Gateway route, kiểm thử Python, Dockerfile, image/SBOM evidence và Kubernetes manifest; phần RAG ingestion/vector-search đầy đủ được trình bày như hướng mở rộng khi chưa có benchmark/evidence sâu.
