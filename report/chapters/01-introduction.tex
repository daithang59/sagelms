...
\begin{itemize}
  \item Ứng dụng SageLMS: frontend React/Vite, Spring Boot Gateway, các service backend chính và AI Tutor FastAPI.
...
\begin{itemize}
  ...
  \item Chuẩn hóa luồng container artifact từ build, scan, push, resolve digest, SBOM đến signing.
