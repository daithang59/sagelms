...
Bằng chứng hình ảnh cho mục này là màn hình GitHub Actions của một PR pass đầy đủ. Trong phần minh chứng bổ sung, nhóm có thể đưa thêm một PR fail để minh họa tác dụng của gate.
...
FluxCD/GitOps runtime & Đạt mức demo & Runtime hiện có FluxCD Kustomization Ready cho app, Harbor, Kyverno và monitoring; minh chứng hình ảnh nên gồm ảnh reconcile hoặc workflow run cuối. \\
