...
import { Bot, MessageSquarePlus, RotateCcw, Send, Sparkles, Trash2, UserRound } from 'lucide-react';
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl text-rose-500 opacity-70 transition hover:bg-rose-50 hover:opacity-100"
