...
export default function QuestionResultPage() {
  ...
  const { getAttemptResult } = useAssessmentAttempt();
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <button onClick={() => navigate(`/courses/${courseId}?assessmentTab=results`)} className="flex items-center gap-2 text-slate-600 hover:text-slate-900">
